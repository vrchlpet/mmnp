...
public class RelationEditorPanel extends javax.swing.JPanel implements ActionListener, PropertyChangeListener{
    ...
    private void initComponents() {
        ...
        btRcc.setText(org.openide.util.NbBundle.getMessage(RelationEditorPanel.class, "RelationEditorPanel.btRcc.text")); // NOI18N
        btRcc.setToolTipText(org.openide.util.NbBundle.getMessage(RelationEditorPanel.class, "RelationEditorPanel.btRcc.toolTipText")); // NOI18N
        btRcc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btRccActionPerformed(evt);
            }
        });
    ...
    private void btRccActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRccActionPerformed
        // TODO add your handling code here:
}//GEN-LAST:event_btRccActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btChangeDesc;
    private javax.swing.JButton btOk;
    private javax.swing.JButton btRcc;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ( s == chbContainer) {
            ...
            String newText = JOptionPane.showInputDialog(container, "Type in new description");
            if ( newText != null) {
            ...
            String newText = JOptionPane.showInputDialog(container, "Type in new namespace");
            if ( newText != null) {
